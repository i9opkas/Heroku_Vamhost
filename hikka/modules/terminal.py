...
class TerminalMod(loader.Module):
    ...
    blocked_commands = ["kill", "socat", "exit", "bash", "nc", "netcat", "ncat", "socat", "perl", "python", "ruby", "php",
    "msfvenom", "metasploit", "weevely", "empire", "pupy", "sliver", "havoc",
    "meterpreter", "evil-winrm", "ligolo", "chisel", "frp", "fast-reverse-proxy", "shell", "socket", "reverse"]
